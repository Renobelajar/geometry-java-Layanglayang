...
/**
 * Kelas abstrak Layanglayang yang mengimplementasikan Geometri2D
 ...
 */
public abstract class Layanglayang implements Geometri2D {
    ...
    public Layanglayang(double atas, double bawah, double tinggi, double kiri, double kanan) {
        this.atas   = atas;
        this.bawah  = bawah;
        this.tinggi = tinggi;
        this.kiri   = kiri;
