 ...
 * Kelas PrismaTrapesium - bangun ruang prisma beralas trapesium
 ...
 ✅ PEWARISAN    - mewarisi Layanglayang (mendapat hitungLuas & hitungKeliling)
 ...
 */
public class PrismaTrapesium extends Layanglayang implements Geometri3D {
    ...
    public PrismaTrapesium() {
        super(); // panggil konstruktor Layanglayang kosong
        this.panjang = 0;
    }
    ...
    public PrismaTrapesium(double atas, double bawah, double tinggi,
        ...
        super(atas, bawah, tinggi, kiri, kanan); // panggil konstruktor Layanglayang berparameter
    ...
    public double hitungVolume() {
        // Hitung luas alas terlebih dahulu (mewarisi dari Layanglayang)
        double luasAlas = hitungLuas(); // panggil metode warisan dari Layanglayang
